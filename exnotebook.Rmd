---
title: "Baby's First R Markdown Notebook: *New Yorker* Caption Contest Choropleths Example"
...
```{r loading libraries, message=FALSE, warning=FALSE, include=TRUE}
...
```{r define theme, message=FALSE, warning=FALSE}
my_theme <- function() {
...
```{r call data/format geodata, message=FALSE, warning=FALSE}
setwd("data")
...
```{r plot total wins, fig.height=4, fig.width=6, message=FALSE, warning=FALSE}
...
```{r plot submissions, fig.height=4, fig.width=6, message=FALSE, warning=FALSE}
...
```{r plot wins per 10k submissions, fig.height=4, fig.width=6, message=FALSE, warning=FALSE}
